...
class SALICON(data.Dataset):
    def __init__(self, root, classes='train',
        ...
        """
        imgs_path = os.path.join(self.root,  'images',self.classes)
        imgs_path=imgs_path+'/'
        self.imgs_list = [imgs_path + f for f in os.listdir(imgs_path) if f.endswith(('.jpg', '.jpeg', '.png'))]
        #print(imgs_path)
        ...
        if self.classes == 'test':
            ...
            maps_path = os.path.join(self.root,  'maps',self.classes)
            fixs_path = os.path.join(self.root,  'fixations/',self.classes)
            maps_path=maps_path+'/'
            fixs_path=fixs_path+'/'+'map/'
